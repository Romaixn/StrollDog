        ...
        <div class="min-h-full flex flex-col justify-center py-12 sm:px-6 lg:px-8">
            ...
            <div class="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
                <div class="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10">
                    <FormKit type="form" form-class="space-y-6" submit-label="S'inscrire" @submit="submit">
                        <div>
                            <FormKit label="Nom d'utilisateur" type="text" validation="required" v-model="form.username"
                                :errors="errors.username" />
                        </div>
                        <div>
                            <FormKit label="E-mail" type="email" validation="required|email" v-model="form.email"
                                :errors="errors.email" />
                        </div>
                        <div>
                        ...
                        <div>
                            <FormKit label="Mot de passe" name="password" type="password" validation="required"
                                v-model="form.password" :errors="errors.password" />
                        </div>
                        <div>
                            <FormKit label="Confirmer le mot de passe" name="password_confirm" type="password" validation="required|confirm"
