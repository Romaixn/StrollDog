        ...
        <div class="relative max-w-7xl mx-auto px-4 sm:px-6">
            <div class="pb-16 px-4 sm:pb-24 sm:px-6 lg:px-8">
                <div class="text-center">
                    ...
                    <p class="mt-1 text-4xl font-extrabold text-gray-900 sm:text-5xl sm:tracking-tight lg:text-6xl">Trouvez votre balade</p>
                    <p class="max-w-xl mt-5 mx-auto text-xl text-gray-500">Tous les lieux ont étés ajoutés par les membres.</p>
                </div>
            </div>
            ...
            <div class="mt-12 max-w-lg mx-auto grid gap-5 lg:grid-cols-3 lg:max-w-none">
                <div v-for="place in places" :key="place.id" class="flex flex-col rounded-lg shadow-lg overflow-hidden">
                    <div class="flex-shrink-0">
                        <img v-if="!isObjectEmpty(place.pictures)" class="h-48 w-full object-cover" :src="'/uploads/images/places/' + place.pictures[0].image" alt="Image de {{ place.title }}" />
                    </div>
