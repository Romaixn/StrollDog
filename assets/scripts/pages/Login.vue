                ...
                <div class="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10">
                    <FormKit type="form" form-class="space-y-6" submit-label="Se connecter" @submit="submit">
                        ...
                        <div class="flex items-center justify-between">
                            <div class="">
                                <FormKit label="Se souvenir de moi" type="checkbox" v-model="form.remember"
                                    :errors="errors.remember" :plugins="[pluginRemoveInnerWrapper]" />
                            </div>
                            <div class="text-sm">
...
export default {
    ...
    methods: {
        ...
        pluginRemoveInnerWrapper(inputNode) {
